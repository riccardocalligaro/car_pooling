   ...
   <div class="container-fluid">
    ...
    <div class="row vertical-center">
        <div class="col-sm-12 col-md-12 col-lg-6 cl1">
            ...
            <p class="d-md-none mx-auto">Entra nel mondo del car pooling, con un click prenoti un viaggio</p>
            <img class="d-block pt-5 mx-auto" height="400px" src="../../assets/illustrations/undraw_city_driver_jh2h.svg" alt=""
                srcset="">
        </div>
