...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="./trip_page.php">CarPooling</a>
        ...
        <div class="col-md-8 order-md-1">
            ...
            if ($res = $stmt->get_result()) {
                while ($row = $res->fetch_assoc()) {
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <img src="' . (empty($row['fotografia_url']) ? 'https://image.ibb.co/jw55Ex/def_face.jpg' : $row['fotografia_url']) . '" class="img img-rounded img-fluid responsive" />
                        </div>
                        <div class="col-md-10">
            ...
            <form class="needs-validation" novalidate="" action="send_trip.php" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="citta" type="text" class="form-control" id="city" placeholder="" required="" value="">
                        <div class="invalid-feedback"> Please enter your shipping address. </div>
                    </div>
                </div>
